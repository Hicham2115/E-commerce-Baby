  ...
  return (
    <section id="hero" className="bg-[#F9F8F6] px-4 py-12 md:px-8 md:py-16 lg:py-20">
      <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
        {/* Left column */}
        <FadeIn direction="left" className="flex flex-col gap-6 lg:gap-8">
        ...
        {/* Right column */}
        <FadeIn direction="right" delay={0.15} className="relative mx-auto w-full max-w-xl lg:max-w-none">
          {/* Decorative blob */}
          <div
            aria-hidden
