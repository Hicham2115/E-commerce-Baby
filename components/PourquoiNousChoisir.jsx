  ...
  return (
    <section id="about" className="bg-white px-4 py-16 md:px-8 md:py-24">
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:gap-14">
        <FadeIn direction="left" className="relative pb-16 sm:pb-20">
        ...
        <FadeIn direction="right" delay={0.1} className="flex flex-col gap-10 lg:gap-12">
          <div className="lg:pt-4">
            ...
            <StaggerContainer className="mt-10 grid gap-8 sm:grid-cols-2 sm:gap-6">
              {features.map((feature) => (
                <StaggerItem key={feature.number}>
                  <div className="group/feature border-l border-[#E8E4DC] pl-6 transition-colors duration-300 hover:border-[#9B4D44]">
