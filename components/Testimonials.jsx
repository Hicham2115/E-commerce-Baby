...
function StarRow({ rating, size = "default" }) {
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        <FadeInUp className="mb-12 text-center md:mb-16">
          ...
          <FadeInUp delay={0.15} className="mt-6 inline-flex flex-wrap items-center justify-center gap-4 rounded-xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur-sm sm:gap-6 md:px-5">
        ...
        <StaggerContainer className="grid auto-rows-fr grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3" staggerDelay={0.08}>
        ...
        <FadeInUp delay={0.2} className="mt-12 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-center text-xs tracking-[0.15em] text-white/40 uppercase md:mt-14 md:text-sm">
