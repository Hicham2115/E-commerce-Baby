  ...
  return (
    <section id="products" className="bg-white px-4 py-16 md:px-8 md:py-24">
      <div className="mx-auto max-w-7xl">
        ...
        {featured.length > 0 ? (
          <StaggerContainer className="grid grid-cols-2 gap-x-5 gap-y-10 sm:grid-cols-2 md:gap-x-6 md:gap-y-12 lg:grid-cols-4">
          ...
          <FadeInUp className="rounded-2xl border border-dashed border-[#D4D0C8] bg-[#F9F8F6] px-6 py-16 text-center">
        ...
        <FadeInUp delay={0.2} className="mt-10 flex justify-center md:mt-12">
          <Button
            asChild
